...
_sportCategories(BookingViewModel model) {
...
/// top subscriptions
///
Widget _topSubScriptions(BookingViewModel model, BuildContext context) {
  return Column(
    mainAxisAlignment: MainAxisAlignment.center,
    crossAxisAlignment: CrossAxisAlignment.center,
    children: [
...
/// Top 10  Fields
///
Widget _top10Fields(BookingViewModel model, BuildContext context) {
  return Column(
    children: [
      _iconAndText(
...
///  store categories
///
_storeCategories(BookingViewModel model) {
  return Column(
    children: [
      _iconAndText(
