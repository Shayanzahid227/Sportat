...
//******************    images and icons *********************//
  ...
  ///
  /// onboarding screen
  String onboarding1 = "$dynamicAssets/onboarding1.png";
  String onboarding2 = "$dynamicAssets/onboarding2.png";
  String onboarding3 = "$dynamicAssets/onboarding3.png";

////
  //************************************ *//
  //                                      //
  //  02 :Login and SigIn up              //
  //                                      //
  //*********************************** *//
  ...
  ///  otp screen
  ///
  String otp = "$dynamicAssets/otp.png";
  ...
  ///
  String countrySearchIcon = "$iconsAssets/search.png";
  String countryTickIcon = "$iconsAssets/tick.png";

  ///
  ///  select city screen
  ///
  String citySearchIcon = "$iconsAssets/search.png";
  String cityTickIcon = "$iconsAssets/tick.png";
  ...
  ///  interests screen
  ///
  String footballIcon = "$iconsAssets/football.png";
  String bookIcon = "$iconsAssets/book.png";
